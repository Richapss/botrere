...
async function ffStalk(id) {
  ...
  let petName = tr[20]?.split(': ')[1] || 'Tidak punya pet.';
  let petLevel = tr[21]?.split(': ')[1] || 'Tidak punya pet.';
  let petExp = tr[22]?.split(': ')[1] || 'Tidak punya pet.';
  let starMarked = tr[23]?.split(': ')[1] || 'Tidak punya pet.';
  let selected = tr[24]?.split(': ')[1] || 'Tidak punya pet.';
  let guild = tr[26] || 'Tidak ada guild.';
